    ...
    System.out.println(fname+lname+email+cno+cid+code);
      try
         ...
         {  %>
           ...
           <center><h1 style="color: red;">EMPLOYEE REGISTERATION FOR TRAINING SUCCESSFULL</h1></center>
             <center><h1 style="color: purple;">You will receive a confirmation mail from admin confirming your registration</h1></center>
