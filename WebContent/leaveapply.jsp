...
String stat="Pending";
          try
           ...
           String query="Select status from empleaveapp where ref_id=(select max(ref_id) from empleaveapp where emp_code="+empcode+")" ;
          ...
          out.println("Your current status of last application sent is " +cstat + "!!!");
           ...
           String str= "Select first_name, last_name from employee where Emp_code=?";
           ...
           String str1="Select status from empleaveapp where emp_code=?";
