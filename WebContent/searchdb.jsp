      ...
      try
          {
           ...
           PreparedStatement st=con.prepareStatement("Select * from employee where first_name=? and last_name=? and designation=? and experience=?");
           ...
           %>
           <p><br/>NAME  :  &nbsp;&nbsp;&nbsp;<%= name %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; EMPLOYEE CODE  :  &nbsp;&nbsp;&nbsp;<%="     "+ ecode %></p> 
           <% 
           }
           if(flag==0)
           {
