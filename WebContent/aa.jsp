...
<%! String name,email,username,designation,exp,cno,hrs,sal,pf,da,ta,hra,net,workdays,sno,fdate,tdate,str,nets;
     int x,days;
     Float earn; %>
<%
...
try
          {
           ...
           String str="Select name,email_id,designation,contact_no,WHOURs,SALARY,PF,DA,TA,HRA,NET_SALARY,fdate,tdate,slip_no from empslip where emp_code=? AND FDATE=? AND TDATE=?";
           ...
           hra=rs.getString(10);
           net=rs.getString(11);
           earn=(Float.parseFloat(hra))+(Float.parseFloat(da))+(Float.parseFloat(ta))+(Float.parseFloat(sal));
...
<table width="900" height="599" border="1">
  ...
  <tr>
    <td height="25"colspan="4"> <div align="right"><em><strong>Slip Number: <%=sno%></strong> </em></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><div align="center"><%=sal %></div></td>
    <td>Provident Fund </td>
    <td><div align="center"><%=pf %></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><div align="center"><%=hra %></div></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="39">T.A</td>
    <td><div align="center"><%=ta %></div></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td height="39" colspan="3"><div align="center"><%=net %></div></td>
  </tr>
  <%
