  ...
  <div class="border">
    ...
    <div id="main">
      <div id="content" class="left">
        <div class="highlight">
        <h2 style="color: red;">Record yo have entered is already exist. If you want to edit the records go below. </h2>
        	...
        	try
        {
        		...
        		String sql="select * from skills where EMP_CODE="+ecode+" ";
        ...
        <br/><br/><br/><br/>
        <form id="addskill" name="addskill" method="post" action="editskilldb.jsp">
