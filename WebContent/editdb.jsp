        ...
        try
          {
           ...
           String str="Update employee SET first_name=?, last_name=?, username=?, pin_code=?, c_address=?, city=?, dob=?, contact_no=?, designation=?, location=?, registration_date=?,  email_id=?, gender=?, experience=? where emp_code=? ";                                     
