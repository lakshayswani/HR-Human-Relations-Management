    ...
    <div id="main">
      <div id="content" class="left">
        <div class="highlight">
          ...
          <center><h3 style="color: red;">Invalid employee code or password !!!</h3></center>
          <form id="emplogin" name="emplogin" method="post" action="verification.jsp">
  <table width="498" height="158" border="0">
    <tr>
      <td width="244">Employee Code </td>
      <td width="244"><label>
    ...
    <tr>
      <td colspan="2"><label>
          ...
          <p> To know your Employee Code Please enter your contact number in the box </p>

<form id="empcode" name="empcode" method="post" action="empprocess.jsp">
  <table width="501" height="77" border="0">
    <tr>
      <td width="243">Contact Number </td>
      <td width="242"><label>
        <input name="num" type="text" value="+91" />
      </label></td>
    </tr>
    <tr>
      <td colspan="2"><label>
